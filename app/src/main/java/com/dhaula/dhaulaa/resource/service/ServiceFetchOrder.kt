...
class ServiceFetchOrder : ApiService<ServiceFetchOrder.Api, Request<HashMap<String, Any>>, Response<ArrayList<MBasketItem>>>() {

    override val aPI: Class<Api>?
        get() = Api::class.java

    interface Api{
        @POST(RouteConstants.URL_FETCH_ORDER_DETAILS)
    ...
    ): Call<Response<ArrayList<MBasketItem>>?>? {
