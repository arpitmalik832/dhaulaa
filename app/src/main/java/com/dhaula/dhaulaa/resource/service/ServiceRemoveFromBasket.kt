...
class ServiceRemoveFromBasket : ApiService<ServiceRemoveFromBasket.Api, Request<HashMap<String, Any>>, Response<MSuccess>>() {

    override val aPI: Class<Api>?
        get() = Api::class.java

    interface Api{
        @POST(RouteConstants.URL_REMOVE_FROM_BASKET)
